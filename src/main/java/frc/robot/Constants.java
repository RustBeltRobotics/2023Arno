...
public final class Constants {
    ...
    public static final int DRIVE_CURRENT_LIMIT = 30; // FIXME: Optimize after driver training/feedback
    public static final int STEER_CURRENT_LIMIT = 20; // FIXME: Optimize after driver training/feedback
    ...
    public static final double AUTOBALANCE_SPEED_FACTOR = 0.5;
    ...
    // Modulue Offsets
    // Charged Up
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(345.23); // FIXME: need offsets for new robot
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(288.37); // FIXME: need offsets for new robot
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(246.09); // FIXME: need offsets for new robot
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(0.62); // FIXME: need offsets for new robot
    ...
    // Free motor speed multiplied by gear ratio, multiplied by pully ratio, multiplied by empirical fudge factor
    public static final double ARM_ROTATION_CONVERSION = (360. / ((4. * 4. * 3) * (1.64) * (196. / 180.)));
