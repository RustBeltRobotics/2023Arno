...
public class CableCube2P extends SequentialCommandGroup {
    public CableCube2P() {
        SmartDashboard.putString("Alliance Color:" , DriverStation.getAlliance().toString());
        List<PathPlannerTrajectory> path = PathPlanner.loadPathGroup("Cable Cube 2P", MAX_TRAJECTORY_VELOCITY, MAX_TRAJECTORY_ACCELERATION);
