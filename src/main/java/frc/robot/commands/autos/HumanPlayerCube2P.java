...
public class HumanPlayerCube2P extends SequentialCommandGroup {
    public HumanPlayerCube2P() {
        List<PathPlannerTrajectory> path = PathPlanner.loadPathGroup("Human Player Cube 2P", MAX_TRAJECTORY_VELOCITY, MAX_TRAJECTORY_ACCELERATION);
