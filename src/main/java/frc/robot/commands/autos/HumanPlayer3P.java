...
public class HumanPlayer3P extends SequentialCommandGroup {
    public HumanPlayer3P() {
        ...
        List<PathPlannerTrajectory> path = PathPlanner.loadPathGroup("Human Player 3P", MAX_TRAJECTORY_VELOCITY, MAX_TRAJECTORY_ACCELERATION);
        ...
        addCommands(
                ...
                // RobotContainer.arm.centerArm(), // FIXME Remove this initial centerarm() from all routines
